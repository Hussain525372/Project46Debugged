...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    var gameOver = createSprite(600, 100, 90, 20);
    var restart = createSprite(600, 150, 70, 20);
  ...
  drawSprites();
  // var gameOver = createSprite(300, 100, 90, 20);
  // var restart = createSprite(300, 150, 70, 20);
  // gameOver.addImage(gameOverImg);
  // gameOver.scale = 0.2;
  // restart.addImage(restartImg);
  // restart.scale = 0.2;
